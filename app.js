...
app.use(cookieSession({ secret: 'hellocat' }));
...
// Tells passport to use that facebook-specific data structure
passport.use(new FacebookStrategy(

  // filling in the blanks on the Facebook strategy
  {
    clientID: '567268120293726',
    clientSecret: 'ddc73d42bd084c53c062e9a6bc6af96c',
